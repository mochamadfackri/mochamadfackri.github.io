                <main>
                    <div class="container-fluid">
                        ...
                        <div class="card mb-4">
                           ...
                           <div class="card-body">
                                   <form method="POST" action="<?php echo base_url().'index.php/Backend/data_pengelola_pusat_aksi' ?>" enctype="multipart/form-data">
                ...
                <div class="from-row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>Berkas :</label>
                            <input type="file" name="berkas" class="form-control" placeholder="Pilih File">
                        </div>
                    </div>
                </div>
                <div class="from-row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="date" name="tgl_terima" class="form-control" placeholder="Masukkan Tanggal Terima ">
                        </div>
                    </div>
                </div>
