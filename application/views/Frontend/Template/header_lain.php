  ...
  <![endif]-->
    ...
    <section id="home" class="header_area">
        ...
        <div class="header_hero">
            <div class="single_hero bg_cover d-flex align-items-center" style="background-image: url(<?php echo base_url().'assets/Frontend/img/bg3.jpg'?>)">
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-lg-8 col-md-10">
                            <div class="hero_content text-center">
                                <h2 class="hero_title wow fadeInUp" data-wow-duration="1.3s" data-wow-delay="0.2s">Welcome to Inventarisir</br>E-Government</h2>
                                <p class="wow fadeInUp" data-wow-duration="1.3s" data-wow-delay="0.5s"><br class="d-none d-xl-block">Home/Bidang Layanan Inventaris E-Goverment</p>
